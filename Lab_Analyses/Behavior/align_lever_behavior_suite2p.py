...
from Lab_Analyses.Behavior.align_lever_behavior import align_activity
from Lab_Analyses.Behavior.read_bit_code import read_bit_code
from Lab_Analyses.Utilities.save_load_pickle import save_pickle


def align_lever_behavior_suite2p(
    behavior_data,
    imaging_data,
    save=None,
    save_path=None,
    ...
    for i in trial_idxs:
        ...
        if (
            behavior_data.behavior_frames[i].states.state_0[1, 0]
            > imaging_data.processed_dFoF.shape[0]
        ):
            continue
    ...
    aligned_activity_data = Trial_Aligned_Suite2P_Activity(
        mouse_id=behavior_data.mouse_id,
        session=behavior_data.sess_name,
        date=behavior_data.date,
